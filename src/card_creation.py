...
def create_character_card(character_name):
    ...
    template = Image.open("assets/templates/character_card_template.png")
    ...
    face = Image.open("assets/character_art/" + processed_char_name + ".png").resize((sy['splash_art']['w'], sy['splash_art']['h']))
